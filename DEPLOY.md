...
PORT=3000
ADMIN_ID=...          # Telegram ID администратора → открывает команду /stats
```
...
Исходники в `ios-app/`. Требует Mac + Xcode 15+.

**Подробная инструкция:** `ios-app/SETUP.md`
**Что нужно добавить на VPS:** `ios-app/BACKEND_CHANGES.md` (эндпоинт `POST /api/chat`)

> iOS app пока не подключён к бэкенду — VPS принимает только Telegram-вебхуки. Инструкция по добавлению REST API для iOS в `BACKEND_CHANGES.md`.
